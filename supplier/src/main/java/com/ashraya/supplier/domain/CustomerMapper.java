...
public class CustomerMapper {
    ...
    public static GoogleAccountInfo mapToGoogleAccountInfo(LoginRequestPayload payload) {
        return GoogleAccountInfo.builder()
        		...
        		.displayName(payload.getFirstName()).emailId(payload.getEmailId())
    ...
    public static WaterSupplier mapToWaterSupplier(LoginRequestPayload payload, FacebookAccountInfo facebookAccountInfo, GoogleAccountInfo googleAccountInfo, Category category) {
        return WaterSupplier.builder().facebookAccountInfo(facebookAccountInfo).googleAccountInfo(googleAccountInfo).gstNum(payload.getGstNumber())
                        .mobileNumber(payload.getPhoneNumber()).userName(payload.getDisplayName()).appUsage(payload.getAppUsage()).category(category)
